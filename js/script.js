...
// Optional: Add intersection observer for enhanced animations
function initFunfactsAnimations() {
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // Initialize funfacts animations
  initFunfactsAnimations();
});

// Optional: Add counter animation for statistics
...
// Trigger counter animation when funfacts section comes into view
